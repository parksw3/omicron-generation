...
fit_lognormal_r_comb_sgtf_within <- lapply(r_sgtf, function(r) {
  print(r)
  ...
  ff <- fitfun_lognormal(data=data_comb_sgtf_within, 
                         ...
                         logsd_gen=coef(fit_lognormal_base_comb_sgtf_within)[[1]], 
...
save("fit_lognormal_r_comb_sgtf_within", "fit_lognormal_r_comb_nsgtf_within", file="fit_lognormal_comb_within_r.rda")
