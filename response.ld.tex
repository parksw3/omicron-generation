...
%DIF DEL response.tex.HEAD.oldfile   Mon Nov 28 09:52:20 2022
%DIF ADD response.tex                Mon Nov 28 09:52:00 2022
...
Even if Delta and Omicron variants had identical }\DIFdelend \DIFaddbegin \DIFadd{:
immune evasion could have allowed Omicron to replace Delta even without differences in }\DIFaddend intrinsic generation-interval distributions\DIFdelbegin \DIFdel{, immune evasiveness alone would allow the Omicron variant to become dominant}\DIFdelend .
Therefore, we might expect the differences in the intrinsic generation-interval distributions of the Delta and Omicron infections to be more strongly influenced by the intrinsic differences in their viral kinetics. \DIFaddbegin \DIFadd{\jd{The logic for this last s.~feels weak to me. How important is this point?}
}

\DIFadd{\jd{We're being very subtle here and maybe could explain better. Intrinsic includes the immune landscape, but not interventions or behaviour, right? I think it's fine, but I wonder if we could make it easier for readers a bit.}
}\DIFaddend 
...
\DIFaddbegin \DIFadd{\jd{This s.~is now using intrinsic a bit differently. I'll try to edit.}
}\DIFaddend In addition, the \DIFaddbegin \DIFadd{counter-factual initial }\DIFaddend intrinsic generation intervals \DIFdelbegin \DIFdel{of both Omicron and Delta }\DIFdelend \DIFaddbegin \DIFadd{(for a naive population) of both }\DIFaddend variants are likely longer than what we estimate given existing levels of interventions, including vaccination, and pandemic awareness---estimating \DIFaddbegin \DIFadd{initial }\DIFaddend intrinsic generation-interval distributions of SARS-CoV-2 variants is expected to be a difficult problem as it requires data from times when awareness levels were low \citep{sender2021unmitigated}.
