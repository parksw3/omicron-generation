...
rpcall("compare.Rout compare.R R/serialfun.R rdaout/calculate_incubation_mle.rda rdaout/fit_lognormal_base_comb_within.rda rdaout/fit_lognormal_base_comb_between.rda rdaout/fit_lognormal_comb_within_r.rda rdaout/fit_lognormal_comb_between_r.rda")
...
g1 <- ggplot(serialdata_comb_nsgtf_within) +
  ...
  scale_x_continuous("Within-household\nserial intervals (days)", expand=c(0, 0), limits=c(xmin, xmax)) +
...
saveGG(gcomb1, width=12, height=6)
