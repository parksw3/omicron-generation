...
r_nsgtf <- -0.05
r_sgtf <- 0.15
rhovec <- seq(0.5, 0.85, length.out=11)
...
save("fit_lognormal_base_rho_comb_nsgtf_within", "fit_lognormal_base_rho_comb_sgtf_within", file="fit_lognormal_base_comb_rho.rda")
