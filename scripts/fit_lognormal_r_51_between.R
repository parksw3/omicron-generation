...
fit_lognormal_r_51_nsgtf_between <- lapply(r_nsgtf, function(r) {
  ...
  ff <- fitfun_lognormal(data=data_51_nsgtf_between, 
...
fit_lognormal_r_51_sgtf_between <- lapply(r_sgtf, function(r) {
  print(r)
  ...
  if (r < 0.2) {
    ff <- fitfun_lognormal(data=data_51_sgtf_between, 
    ...
    ### weird non-finite finite-difference value [1] error...
    ff <- fitfun_lognormal(data=data_51_sgtf_between, 
                           logmean_gen=1, 
                           logsd_gen=0.5, 
                           logmean_inc=logmean_inc_sgtf, 
...
saveVars("fit_lognormal_r_51_sgtf_between", "fit_lognormal_r_51_nsgtf_between")
