...
Incubation period data are not publicly available with the original article; instead, we rely on previously-estimated incubation-period distributions by \cite{backer2021omicron} to derive growth-rate-adjusted .
