...
\cite{ito2022estimating,selby2022generation} tried to estimate the generation-interval distributions of the Omicron varaint but they both relied on population-level epidemic dynamics (rather than individual-level transmission data).
...
We considered two ways of measuring transmission advantanges: growth-rate differences and reproduction advantage.
...
Sensitivity of the mean forward generation-interval estimates to assumed growth rates of the Delta and Omicron variants stratified by the types of transmission (within- vs between-househol transmission) and the week of infectors' symptom onset (weeks 50 vs 51 of 2021).
Lines represent maximum likelihood estimates.
Shaded regions represent the corresponding 95\% confidence intervals.
}
\end{figure}
