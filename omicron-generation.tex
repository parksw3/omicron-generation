...
Sebastian Funk\textsuperscript{3}, 
Bryan T. Grenfell\textsuperscript{1,8},
Jantien A Backer\textsuperscript{9},
Jacco Wallinga\textsuperscript{9,10},
Cecile Viboud\textsuperscript{2},
Jonathan Dushoff\textsuperscript{11,12,13}
\\
\bigskip
...
\\
\textbf{8} Princeton School of Public and International Affairs, Princeton University, Princeton, NJ, USA
\\
\textbf{9} Center for Infectious Disease Control, National Institute for Public Health and the Environment (RIVM), Bilthoven, The Netherlands
\\
\textbf{10} Department of Biomedical Data Sciences, Leiden University Medical Center, Leiden, The Netherlands
\\
\textbf{11} Department of Biology, McMaster University, Hamilton, ON, Canada
\\
\textbf{12} Department of Mathematics and Statistics, McMaster University, Hamilton, ON, Canada
\\
\textbf{13} M.\,G.\,DeGroote Institute for Infectious Disease Research, McMaster University, Hamilton, ON, Canada
\\
\bigskip
