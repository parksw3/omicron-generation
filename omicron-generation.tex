...
%\cite{ito2022estimating,selby2022generation} tried to estimate the generation-interval distributions of the Omicron varaint from population-level epidemic dynamics (rather than individual-level transmission data).
