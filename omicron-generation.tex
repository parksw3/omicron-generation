...
\\
\textbf{10} Center for Infectious Disease Control, WHO COVID-19 reference laboratory, National Institute for Public Health and the Environment (RIVM), Bilthoven, The Netherlands
\\
...
The differences in realized generation intervals may be driven by the network effect---higher effective reproduction numbers of the Omicron variant can cause faster susceptible depletion among contact networks, which in turn prevents late transmission (therefore shortening realized generation intervals).
...
We note that the proportion of Delta and Omicron variants detected is reported by the date of sampling, whereas the case data are reported by the date of reports, meaning that there is some delay between the two data sets.
...
We also do not account for uncertainties around the estimates of the proportion of each variant---almost 2000 samples were tested on each week between the week of November 28, 2021, and the week of January 23, 2022, making this uncertainty negligible.
